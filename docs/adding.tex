...
to its openness as well as the wide variety of platforms it can run on. Many
...
If your device needs to be flashed every time you load a firmware, the bootloader might
...
changes between kernel versions. Additionally, if you want to avoid creating a patch that will create files, you can put those files into \texttt{files} or \texttt{files-2.6.x}
