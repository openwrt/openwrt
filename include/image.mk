...
define Image/BuildKernel/MkuImage
	mkimage -A $(ARCH) -O linux -T kernel -C $(1) -a $(2) -e $(3) \
		-n '$(call toupper,$(ARCH)) CShoreWrt Linux-$(LINUX_VERSION)' -d $(4) $(5)
endef
...
define Build/uImage
	mkimage -A $(LINUX_KARCH) \
		...
		-n '$(call toupper,$(LINUX_KARCH)) CShoreWrt Linux-$(LINUX_VERSION)' -d $@ $@.new
	@mv $@.new $@
endef
...
define Build/netgear-dni
	$(STAGING_DIR_HOST)/bin/mkdniimg \
		-B $(NETGEAR_BOARD_ID) -v CShoreWrt.$(REVISION) \
