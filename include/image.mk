...
# Deterministic ext4 filesystem UUID and directory hash seed, reusing the
# IMG_PART_DISKGUID derivation so that mke2fs output stays reproducible.
EXT4_UUID:=$(IMG_PART_DISKGUID)
endif
