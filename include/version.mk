...
VERSION_NUMBER:=$(if $(VERSION_NUMBER),$(VERSION_NUMBER),life2.3)

VERSION_CODE:=$(call qstrip,$(CONFIG_VERSION_CODE))
VERSION_CODE:=$(if $(VERSION_CODE),$(VERSION_CODE),2020-07-02)

VERSION_REPO:=$(call qstrip,$(CONFIG_VERSION_REPO))
VERSION_REPO:=$(if $(VERSION_REPO),$(VERSION_REPO),https://openwrt.ikghx.com/life2.3)
