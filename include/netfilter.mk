...
$(eval $(if $(NF_KMOD),$(call nf_add,NF_IPT,CONFIG_IP_NF_IPTABLES CONFIG_IP_NF_IPTABLES_LEGACY, $(P_V4)ip_tables),))
...
$(eval $(if $(NF_KMOD),$(call nf_add,NF_IPT6,CONFIG_IP6_NF_IPTABLES CONFIG_IP6_NF_IPTABLES_LEGACY, $(P_V6)ip6_tables),))
...
$(eval $(if $(NF_KMOD),$(call nf_add,EBTABLES,CONFIG_BRIDGE_NF_EBTABLES CONFIG_BRIDGE_NF_EBTABLES_LEGACY, $(P_EBT)ebtables),))
