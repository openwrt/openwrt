...
ifdef PKG_SOURCE_DIR
  PKG_UNPACK_DIR ?= $(PKG_SOURCE_DIR)
  PKG_UNPACK ?= $(SH_FUNC) $(call UNPACK_CMD,$(PKG_UNPACK_DIR))
endif
ifdef HOST_SOURCE_DIR
  HOST_UNPACK_DIR ?= $(HOST_SOURCE_DIR)
  HOST_UNPACK ?= $(SH_FUNC) $(call UNPACK_CMD,$(HOST_UNPACK_DIR))
endif
