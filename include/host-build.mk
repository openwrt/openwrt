...
BUILD_TYPES += host
HOST_STAMP_NO_AUTOREBUILD=$(wildcard $(HOST_BUILD_DIR)/.no_autorebuild)
PREV_HOST_STAMP_PREPARED:=$(if $(HOST_STAMP_NO_AUTOREBUILD),$(wildcard $(HOST_BUILD_DIR)/.prepared*))
ifneq ($(PREV_HOST_STAMP_PREPARED),)
  HOST_STAMP_PREPARED:=$(PREV_HOST_STAMP_PREPARED)
  CONFIG_AUTOREBUILD:=
else
