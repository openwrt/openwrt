# uxc container package-hook helpers, sourced by the install scripts of
# container-<name> and stack-<app> packages.
...
# The $IPKG_INSTROOT guards live in this file rather than in an
# in-Makefile define, where make eats the dollar sign.
uxc_stack_postinst() {
	local app="$1"
