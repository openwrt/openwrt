...
o = s:option(ListValue, "pdnsd_enable", translate("Resolve Dns Mode"), translate("If you turn on adguardhome, choose to use the DNS service with the local port of 5335") .. button)
