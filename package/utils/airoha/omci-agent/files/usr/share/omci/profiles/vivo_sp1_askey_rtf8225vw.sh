...
PROFILE_ID='vivo_sp1_askey_rtf8225vw'
...
case "$1" in
	describe)
		cat <<'JSON'
{"order":20,"id":"vivo_sp1_askey_rtf8225vw","name":"Vivo SP1 - Askey RTF8225VW","description":"Emulates the Askey RTF8225VW identity used by Vivo SP1 with the Nokia OLT interoperability profile.","inputs":[{"name":"gpon_sn","label":"GPON SN","type":"text","required":true,"placeholder":"TLCM12345678","pattern":"^(?:[A-Za-z0-9]{4}[0-9A-Fa-f]{8}|[0-9A-Fa-f]{16})$","max_length":16},{"name":"slid","label":"SLID / GPON password","type":"password","required":true,"placeholder":"Enter the Vivo SLID","pattern":"^[ -~]{1,32}$","max_length":32}],"settings":["Vendor ID: TLCM","Equipment ID: RTF8225VW","Software 0: R8225VWTEF004","Software 1: P8225VWTEF004","OMCC: 0x80","OLT profile: Nokia"]}
JSON
		;;
	apply)
...
set omci.main.vendor_id='TLCM'
set omci.main.equipment_id='RTF8225VW'
set omci.main.hardware_version='RTF8225VW'
set omci.main.software_version_0='R8225VWTEF004'
set omci.main.software_version_1='P8225VWTEF004'
set omci.main.version='R8225VWTEF004'
