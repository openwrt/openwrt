...
int gponDevGetSniffMode(GPON_DEV_SNIFFER_MODE_T *sniffer);	/* PORT: prototype (defined in gpon_dev.c) */
int gponDevEnableSniffMode(XPON_Mode_t enable);			/* PORT: prototype (defined in gpon_dev.c) */
