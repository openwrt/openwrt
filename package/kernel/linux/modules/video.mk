...
define KernelPackage/dvb-pctv461e
	SUBMENU:=$(VIDEO_MENU)
	TITLE:=PCTV 461e DVB-S2 support
	DEPENDS:=+kmod-i2c-core +kmod-i2c-mux +kmod-media +kmod-rc-keymap-pinnacle-pctv-hd \
		 +kmod-regmap-i2c +kmod-usb2 +pctv461e-firmware
	KCONFIG:= \
		CONFIG_DVB_A8293 \
	...
	FILES:= \
		$(LINUX_DIR)/drivers/media/dvb-frontends/a8293.ko \
...
define KernelPackage/dvb-pctv461e/description
	Kernel module for PCTV 461e DVB-S2 support.
endef

$(eval $(call KernelPackage,dvb-pctv461e))
...
define KernelPackage/media
	SUBMENU:=$(VIDEO_MENU)
	TITLE:=Multimedia video cards support
	DEPENDS:=+kmod-i2c-core +kmod-rc-core
	KCONFIG:= \
	...
	AUTOLOAD:=$(call AutoProbe,dvb-core media tveeprom v4l2-common videodev)
endef

define KernelPackage/media/description
	Kernel module for multimedia video cards support.
endef
