...
define KernelPackage/can-flexcan
  ...
  FILES:= \
	drivers/net/can/flexcan.ko@lt5.17 \
	drivers/net/can/flexcan/flexcan.ko@ge5.17
...
define KernelPackage/can-slcan
  ...
  FILES:= \
	drivers/net/can/slcan.ko@lt6.0 \
	drivers/net/can/slcan/slcan.ko@ge6.0
...
define KernelPackage/can-usb-esd
  ...
  FILES:= \
	drivers/net/can/usb/esd_usb2.ko@lt6.0 \
	drivers/net/can/usb/esd_usb.ko@ge6.0
