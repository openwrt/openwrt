...
define KernelPackage/sound-soc-an7581-wm8960
  TITLE:=Airoha AN7581 audio support (Wolfson Audio WM8960 codec)
  ...
  DEPENDS:=@TARGET_airoha_an7581 +kmod-sound-soc-wm8960 +kmod-sound-soc-an7581
  $(call AddDepends/sound)
endef
