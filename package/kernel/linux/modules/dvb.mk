...
define KernelPackage/dvb-usb-dibusb-mc-common
  TITLE:=Common library for DiBcom USB MC drivers
  HIDDEN:=1
  FILES:=$(LINUX_DIR)/drivers/media/usb/dvb-usb/dvb-usb-dibusb-mc-common.ko
  AUTOLOAD:=$(call AutoProbe,dvb-usb-dibusb-mc-common)
  $(call AddDepends/dvb-usb,+kmod-dvb-usb-dibusb-common +kmod-dvb-dib3000mc)
endef
...
define KernelPackage/dvb-usb-a800
  ...
  $(call AddDepends/dvb-usb,+kmod-dvb-dib3000mc +kmod-dvb-usb-dibusb-common +kmod-dvb-usb-dibusb-mc-common)
endef
...
define KernelPackage/dvb-usb-v2
  ...
  DEPENDS:=+kmod-i2c-core +PACKAGE_kmod-rc-core:kmod-rc-core
...
define KernelPackage/media-tuner-si2157
  ...
  DEPENDS+=+kmod-regmap-i2c +kmod-media-controller
endef
...
define KernelPackage/tveeprom
  SUBMENU:=$(VIDEO_MENU)
  TITLE:=TV hardware capabilities EEPROM support
  HIDDEN:=1
...
define KernelPackage/tveeprom/description
 Kernel module to read the EEPROM found on TV tuner cards, which
 describes the hardware capabilities of the card.
endef
...
define KernelPackage/video-em28xx-dvb
  TITLE:=DVB/ATSC support for em28xx based TV cards
  KCONFIG:=CONFIG_VIDEO_EM28XX_DVB
  FILES:=$(LINUX_DIR)/drivers/media/usb/em28xx/em28xx-dvb.ko
  AUTOLOAD:=$(call AutoProbe,em28xx-dvb)
  DEPENDS+=+kmod-dvb-core +kmod-video-em28xx
  SUBMENU:=$(VIDEO_MENU)
endef

define KernelPackage/video-em28xx-dvb/description
  DVB/ATSC support for em28xx
endef

$(eval $(call KernelPackage,video-em28xx-dvb))
