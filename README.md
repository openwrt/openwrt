...
This readme contains the basics of building and modifying OpenWrt for Ci40. *You will find much more documentation on the [Creator Documentation website](http://docs.creatordev.io/ci40).*
