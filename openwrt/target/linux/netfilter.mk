...
IPT_CONNTRACK-$(CONFIG_NETFILTER_XT_MATCH_CONNTRACK) += ipt_conntrack
IPT_CONNTRACK-$(CONFIG_IP_NF_MATCH_HELPER) += ipt_helper
IPT_CONNTRACK-$(CONFIG_NETFILTER_XT_MATCH_HELPER) += ipt_helper
IPT_CONNTRACK-$(CONFIG_IP_NF_MATCH_STATE) += ipt_state
IPT_CONNTRACK-$(CONFIG_NETFILTER_XT_MATCH_STATE) += ipt_state


IPT_EXTRA-m :=
IPT_EXTRA-$(CONFIG_IP_NF_MATCH_CONDITION) += ipt_condition
IPT_EXTRA-$(CONFIG_IP_NF_MATCH_CONNBYTES) += ipt_connbytes
IPT_EXTRA-$(CONFIG_NETFILTER_XT_MATCH_CONNBYTES) += ipt_connbytes
IPT_EXTRA-$(CONFIG_IP_NF_MATCH_LIMIT) += ipt_limit
IPT_EXTRA-$(CONFIG_NETFILTER_XT_MATCH_LIMIT) += ipt_limit
...
IPT_EXTRA-$(CONFIG_NETFILTER_XT_MATCH_PKTTYPE) += ipt_pkttype
...
IPT_EXTRA-$(CONFIG_NETFILTER_XT_MATCH_STRING) += ipt_string
