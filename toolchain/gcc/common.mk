...
PKG_GPG_KEYS_DIR := $(TOPDIR)/toolchain/gcc/keys
export PKG_GPG_KEYS_DIR

PKG_SOURCE_SIG:=$(PKG_SOURCE).sig

ifeq ($(PKG_VERSION),11.3.0)
  PKG_HASH:=b47cf2818691f5b1e21df2bb38c795fac2cfbd640ede2d0a5e1c89e338a3ac39
  PKG_VALIDPGPKEYS:=7F74F97C103468EE5D750B583AB00996FC26A641
endif
...
ifeq ($(PKG_VERSION),13.4.0)
  ...
  PKG_VALIDPGPKEYS:=B3C4AB72669067F5FA6791B31443EF82B6768BE7
endif

ifeq ($(PKG_VERSION),14.4.0)
  PKG_HASH:=752b6f567beac83159c77a7680b1316bdd784738bff9a9d070112c09da90f6d9
  PKG_VALIDPGPKEYS:=D3A93CAD751C2AF4F8C7AD516C35B99309B5FA62
endif
