...
def main():
	...
	parser.add_argument("-r", "--rootfs", default="", help="Squash filesystem to append in firmware")
	parser.add_argument("-b", "--bootloader", default="", help="Bootloader file to append in firmware")
