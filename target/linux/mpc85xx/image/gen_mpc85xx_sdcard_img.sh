...
# 4 MiB alignment leaves room below the first partition for the raw
# mainline U-Boot SD image; mvebu's copy of this script uses 1024
set $(ptgen -o "$OUTFILE" -h $head -s $sect -l 4096 -S 0x$SIGNATURE $ptgen_args)
printf "Done\n"
