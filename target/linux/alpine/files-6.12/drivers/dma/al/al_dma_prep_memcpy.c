...
al_dma_prep_memcpy_lock(struct dma_chan *c, dma_addr_t dest, dma_addr_t src,
  ...
  dev_dbg(chan->device->common.dev,
          ...
          __func__, chan->idx, (unsigned int)dest, (unsigned int)src, len,
          (unsigned int)flags);
  ...
  AL_DMA_STATS_UPDATE(chan, chan->stats_prep.memcpy_num, sw_desc_num_req_orig,
                      chan->stats_prep.memcpy_size, len_orig);
