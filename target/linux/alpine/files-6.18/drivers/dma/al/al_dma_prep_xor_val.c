...
al_dma_prep_xor_val_lock(struct dma_chan *c, dma_addr_t *src,
  ...
  AL_DMA_STATS_UPDATE(chan, chan->stats_prep.xor_val_num, sw_desc_num_req_orig,
                      chan->stats_prep.xor_val_size, len_orig);
