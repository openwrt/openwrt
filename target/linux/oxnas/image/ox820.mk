...
define Device/akitio_mycloud
  ...
  DEVICE_MODEL := myCloud (mini) / SilverStone DC01
...
define Device/cloudengines_pogoplugpro
  ...
  DEVICE_MODEL := PogoPlug Pro
  DEIVCE_VARIANT := with mPCIe
...
define Device/cloudengines_pogoplug-series-3
  DEVICE_VENDOR := Cloud Engines
  DEVICE_MODEL := PogoPlug Series V3
  DEVICE_VARIANT := without mPCIe
