...
#define RTL839X_IMR_PORT_MEDIA_CHG		(0x0070)
#define RTL839X_ISR_PORT_MEDIA_CHG		(0x00A8)
#define RTL839X_IMR_SERDES			(0x008C)
#define RTL839X_ISR_SERDES			(0x00c4)
...
#define RTL838X_IMR_PORT_MEDIA_CHG		(0x1108)
#define RTL838X_ISR_PORT_MEDIA_CHG		(0x1150)

/* Interrupt registers for SDS status on 9300 */
#define RTL930X_IMR_SERDES_LINK_FAULT_P		(0xC634)
#define RTL930X_ISR_SERDES_LINK_FAULT_P		(0xC668)
#define RTL930X_IMR_SERDES_RX_SYM_ERR		(0xC638)
#define RTL930X_ISR_SERDES_RX_SYM_ERR		(0xC66C)
...
#define RTL931X_ISR_SDS_UPD_PHYSTS		(0x12E8)
#define RTL931X_IMR_SERDES_ERR			(0x1274)
...
#define RTL838X_EEE_EEEP_PORT_TX_STS		(0x0154)
#define RTL838X_EEE_EEEP_PORT_RX_STS		(0x0158)
#define RTL838X_EEE_TX_SEL_CTRL0		(0xA9F8)
#define RTL838X_EEE_TX_SEL_CTRL1		(0xA9FC)

#define RTL839X_EEE_TX_SEL_CTRL0		(0x041C)
#define RTL839X_EEE_TX_SEL_CTRL1		(0x0420)
#define RTL839X_EEE_TX_CTRL			(0x0424)
...
#define RTL930X_EEE_TX_MINIFG_CTRL0		(0xC720)
#define RTL930X_EEE_TX_MINIFG_CTRL1		(0xC724)
#define RTL930X_EEE_TX_MINIFG_CTRL2		(0xC728)

#define RTL931X_MAC_EEE_ABLTY			(0xF08)
...
#define RTL931X_EEE_TX_MINIFG_CTRL0		(0x5658)
#define RTL931X_EEE_TX_MINIFG_CTRL1		(0x565C)
#define RTL931X_EEE_TX_MINIFG_CTRL2		(0x5660)
...
#define RTL930X_L3_HW_LU_KEY_CTRL_ROUTE_TYPE_MASK       GENMASK(20, 19)
#define RTL930X_L3_HW_LU_KEY_CTRL_ROUTE_TYPE_OFFSET     19
#define RTL903X_L3_HW_LU_KEY_CTRL_ROUTE_TYPE(r) \
        (((r) << RTL930X_L3_HW_LU_KEY_CTRL_ROUTE_TYPE_OFFSET) & RTL930X_L3_HW_LU_KEY_CTRL_ROUTE_TYPE_MASK)
#define RTL903X_L3_HW_LU_KEY_CTRL_ROUTE_TYPE_IPV4UC             0x0
#define RTL903X_L3_HW_LU_KEY_CTRL_ROUTE_TYPE_IPV4MC             0x1
#define RTL903X_L3_HW_LU_KEY_CTRL_ROUTE_TYPE_IPV6UC             0x2
#define RTL903X_L3_HW_LU_KEY_CTRL_ROUTE_TYPE_IPV6MC             0x3
