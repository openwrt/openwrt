...
define Device/edgecore_ecs2100-52t
  ...
  IMAGE_SIZE := 30720k
  # 0x01d8 is the ECS2100-52T board ID
  KERNEL := $$(KERNEL/rt-loader) | uImage none | edgecore-header 01d8
  KERNEL_INITRAMFS := $$(KERNEL/rt-loader) | uImage none | edgecore-header 01d8
  DEVICE_PACKAGES := \
	kmod-eeprom-at24 \
	kmod-hwmon-adt7470 \
	kmod-hwmon-lm75 \
