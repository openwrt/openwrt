...
/*
 * VLAN table entry: member [10:0], untag [21:11], FID/MSTI [23:22], and
 * IVL/SVL [25] (1 = IVL). SVLAN check [24] and extended mask index [30:26]
 * are left at 0.
 */
#define VLAN_MBR_MASK		0x7ff
#define VLAN_UNTAG_SHIFT	11
#define VLAN_FID_MSTI_MASK	GENMASK(23, 22)
