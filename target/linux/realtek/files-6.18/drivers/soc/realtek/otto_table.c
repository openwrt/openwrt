 ...
 * whether the read/write bit is inverted, whether there is an execute bit The
 * enum, the descriptors and the per-register width limit are all generated from
