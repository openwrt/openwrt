...
static int rtl839x_set_distribution_algorithm(struct rtl838x_switch_priv *priv,
					    ...
					    u64 members, struct netdev_lag_upper_info *info)
{
	...
	priv->r->mask_port_reg_be(clear, priv->lags_port_members[group],
...
const struct rtl838x_reg rtl839x_reg = {
	...
	.lag_set_distribution_algorithm = rtl839x_set_distribution_algorithm,
