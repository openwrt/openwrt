...
/* CPU tag definitions for RTL930X */
#define SM(_v, _f)				(((_v) << _f##_LSB) & _f##_MASK)

#define RTL930X_CPU_TAG1_FWD_LSB		8
#define RTL930X_CPU_TAG1_FWD_MSB		(RTL930X_CPU_TAG1_FWD_LSB + 3)
#define RTL930X_CPU_TAG1_FWD_MASK		GENMASK(RTL930X_CPU_TAG1_FWD_MSB, \
							RTL930X_CPU_TAG1_FWD_LSB)

#define RTL930X_CPU_TAG1_FWD_ALE		0
#define RTL930X_CPU_TAG1_FWD_PHYSICAL		1
#define RTL930X_CPU_TAG1_FWD_LOGICAL		2
#define RTL930X_CPU_TAG1_FWD_TRUNK		3
#define RTL930X_CPU_TAG1_FWD_ONE_HOP		4
#define RTL930X_CPU_TAG1_FWD_LOGICAL_ONE_HOP	5
#define RTL930X_CPU_TAG1_FWD_UCST_CPU_MIN_PORT	6
#define RTL930X_CPU_TAG1_FWD_UCST_CPU		7
#define RTL930X_CPU_TAG1_FWD_BCST_CPU		8

#define RTL930X_CPU_TAG1_IGNORE_STP_LSB		2
#define RTL930X_CPU_TAG1_IGNORE_STP_MSB		(RTL930X_CPU_TAG1_IGNORE_STP_LSB)
#define RTL930X_CPU_TAG1_IGNORE_STP_MASK	GENMASK(RTL930X_CPU_TAG1_IGNORE_STP_MSB, \
							RTL930X_CPU_TAG1_IGNORE_STP_LSB)

/* CPU tag definitions for RTL931X */
#define RTL931X_CPU_TAG1_FWD_LSB		8
#define RTL931X_CPU_TAG1_FWD_MSB		(RTL931X_CPU_TAG1_FWD_LSB + 3)
#define RTL931X_CPU_TAG1_FWD_MASK		GENMASK(RTL931X_CPU_TAG1_FWD_MSB, \
							RTL931X_CPU_TAG1_FWD_LSB)

#define RTL931X_CPU_TAG1_FWD_ALE		0
#define RTL931X_CPU_TAG1_FWD_PHYSICAL		1
#define RTL931X_CPU_TAG1_FWD_LOGICAL		2
#define RTL931X_CPU_TAG1_FWD_TRUNK		3
#define RTL931X_CPU_TAG1_FWD_ONE_HOP		4
#define RTL931X_CPU_TAG1_FWD_LOGICAL_ONE_HOP	5
#define RTL931X_CPU_TAG1_FWD_UCST_CPU_MIN_PORT	6
#define RTL931X_CPU_TAG1_FWD_UCST_CPU		7
#define RTL931X_CPU_TAG1_FWD_BCST_CPU		8

#define RTL931X_CPU_TAG1_IGNORE_STP_LSB		2
#define RTL931X_CPU_TAG1_IGNORE_STP_MSB		(RTL931X_CPU_TAG1_IGNORE_STP_LSB)
#define RTL931X_CPU_TAG1_IGNORE_STP_MASK	GENMASK(RTL931X_CPU_TAG1_IGNORE_STP_MSB, \
							RTL931X_CPU_TAG1_IGNORE_STP_LSB)
