...
typedef struct {
  FpmPoolPoolAlloc                    Pool1AllocDealloc;       
                                                                 
  FpmPoolPoolAlloc                    Pool2AllocDealloc;       
                                                                 
  FpmPoolPoolAlloc                    Pool3AllocDealloc;       
                                                                 
  FpmPoolPoolAlloc                    Pool4AllocDealloc;       
                                                                 
  uint32                              Spare;                   
  FpmPoolPoolMulti                    PoolMulti;               
}  FpmPoolRegs;
