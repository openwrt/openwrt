...
define Device/arcadyan_arv7519rw22
  ...
  KERNEL_SIZE := 2048k
  IMAGE_SIZE := 31232k
  DEVICE_PACKAGES := kmod-usb-dwc2 xrx200-phy22f-firmware
...
define Device/arcadyan_vgv7510kw22-brn
  ...
  DEVICE_PACKAGES := kmod-rt2800-pci wpad-basic-mbedtls kmod-usb-dwc2 kmod-ltq-tapi \
	kmod-ltq-vmmc xrx200-phy22f-firmware
...
define Device/arcadyan_vgv7519-brn
  ...
  DEVICE_PACKAGES := kmod-rt2800-pci wpad-basic-mbedtls kmod-usb-dwc2 kmod-ltq-tapi \
	kmod-ltq-vmmc xrx200-phy11g-firmware
...
define Device/avm_fritz3390
  ...
  DEVICE_PACKAGES := kmod-ath9k kmod-owl-loader wpad-basic-mbedtls \
	kmod-usb-dwc2 fritz-tffs xrx200-phy11g-firmware
endef
...
define Device/avm_fritz7412
  ...
  IMAGE_SIZE := 49152k
  DEVICE_PACKAGES := kmod-ath9k kmod-owl-loader wpad-basic-mbedtls \
	fritz-tffs-nand fritz-caldata xrx200-phy22f-firmware
endef
...
define Device/avm_fritz7430
  ...
  IMAGE_SIZE := 49152k
  DEVICE_PACKAGES := kmod-ath9k kmod-owl-loader wpad-basic-mbedtls \
	kmod-usb-dwc2 fritz-tffs-nand fritz-caldata xrx200-phy22f-firmware
endef
