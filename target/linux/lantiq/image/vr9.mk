...
define Device/avm_fritz3490_micron
  $(Device/dsa-migration)
  $(Device/AVM)
  $(Device/NAND)
  DEVICE_MODEL := FRITZ!Box 3490
  ...
  DEVICE_PACKAGES := kmod-usb3 fritz-tffs kmod-avm-wasp \
	-kmod-owl-loader -dsl-vrx200-firmware-xdsl-a -dsl-vrx200-firmware-xdsl-b-patch
endef
TARGET_DEVICES += avm_fritz3490_micron
...
define Device/avm_fritz5490_micron
  $(Device/dsa-migration)
  $(Device/AVM)
  $(Device/NAND)
  DEVICE_MODEL := FRITZ!Box 5490
  ...
  DEVICE_PACKAGES := kmod-usb3 fritz-tffs kmod-avm-wasp \
	...
	-dsl-vrx200-firmware-xdsl-a -dsl-vrx200-firmware-xdsl-b-patch
endef
TARGET_DEVICES += avm_fritz5490_micron
...
define Device/avm_fritz7490_micron
  $(Device/dsa-migration)
  $(Device/AVM)
  $(Device/NAND)
  DEVICE_MODEL := FRITZ!Box 7490
  ...
  DEVICE_PACKAGES := kmod-usb3 fritz-tffs kmod-avm-wasp kmod-avm-wasp \
	-kmod-owl-loader -dsl-vrx200-firmware-xdsl-a -dsl-vrx200-firmware-xdsl-b-patch
endef
TARGET_DEVICES += avm_fritz7490_micron
