...
define Device/airoha_an7581-evb
  ...
  ARTIFACT/preloader.bin := staging-copy-file rfb-bl2.fip
  ARTIFACT/bl31-uboot.fip := staging-copy-file rfb-bl31-u-boot.fip
...
define Device/airoha_an7581-evb-emmc-kite
  ...
  DEVICE_PACKAGES := kmod-i2c-an7581 airoha-an7581-npu-firmware \
...
define Device/gemtek_w1700k-ubi
  $(call Device/ubi_firmware_chainload)
