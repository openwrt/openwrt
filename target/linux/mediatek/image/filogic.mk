...
define Device/zbtlink_zbt-z8103axde128m
  DEVICE_VENDOR := Zbtlink
  DEVICE_MODEL := ZBT-Z8103AX-D/E 128M
  DEVICE_DTS := mt7981b-zbtlink-zbt-z8103axde128m
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware
  KERNEL_IN_UBI := 1
  UBINIZE_OPTS := -E 5
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += zbtlink_zbt-z8103axde128m
