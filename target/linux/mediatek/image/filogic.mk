...
define Device/tplink_archer-be805
  DEVICE_VENDOR := TP-Link
  DEVICE_MODEL := Archer BE805
  DEVICE_DTS_DIR := ../dts
  IMAGE_SIZE := 40960k
  KERNEL_IN_UBI := 1
  BLOCKSIZE := 128k
  ...
  ARTIFACT/second-u-boot.bin := mt7988-uboot-raw tplink_archer-be805 | libdeflate-gzip | \
	uImage gzip -T standalone -a 0x44000000 -e 0x44000000 -n "OpenWrt U-Boot Chainloader"
endef

define Device/tplink_archer-be805-v1
$(call Device/tplink_archer-be805)
  DEVICE_VARIANT := v1
  DEVICE_DTS := mt7988a-tplink-archer-be805-v1
...
endef
TARGET_DEVICES += tplink_archer-be805-v1

define Device/tplink_archer-be805-v1.20
$(call Device/tplink_archer-be805)
  DEVICE_VARIANT := v1.20
  DEVICE_DTS := mt7988a-tplink-archer-be805-v1.20
  DEVICE_PACKAGES := kmod-leds-lp5523 kmod-mt7996-firmware \
  ...
  IMAGE/sysupgrade.bin := append-kernel | \
	...
	check-size | append-metadata
endef
TARGET_DEVICES += tplink_archer-be805-v1.20
