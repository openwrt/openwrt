...
define Device/acelink_ew-7886cax
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-mt7915e kmod-mt7986-firmware mt7986-wo-firmware
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 65536k
...
define Device/acer_predator-w6
  ...
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-usb3 kmod-mt7915e kmod-mt7916-firmware kmod-mt7986-firmware mt7986-wo-firmware e2fsprogs f2fsck mkf2fs
...
define Device/adtran_smartrg
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h e2fsprogs f2fsck mkf2fs kmod-hwmon-pwmfan
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
...
define Device/asus_rt-ax59u
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-usb3 kmod-mt7915e kmod-mt7986-firmware mt7986-wo-firmware
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
...
define Device/bananapi_bpi-r3
  ...
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-hwmon-pwmfan kmod-i2c-gpio kmod-mt7915e \
		     kmod-mt7986-firmware kmod-sfp kmod-usb3 e2fsprogs f2fsck mkf2fs mt7986-wo-firmware
...
define Device/bananapi_bpi-r3-mini
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_DTS_LOADADDR := 0x43f00000
  DEVICE_PACKAGES := kmod-hwmon-pwmfan kmod-mt7915e kmod-mt7986-firmware \
...
define Device/bananapi_bpi-r4-common
  ...
  DEVICE_DTC_FLAGS := --pad 4096
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-hwmon-pwmfan kmod-i2c-mux-pca954x kmod-eeprom-at24 \
...
define Device/cetron_ct3003
  ...
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  KERNEL_IN_UBI := 1
...
define Device/cmcc_rax3000m
  ...
  DEVICE_DTC_FLAGS := --pad 4096
  DEVICE_DTS_LOADADDR := 0x43f00000
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware kmod-usb3 \
...
define Device/confiabits_mt7981
  ...
  KERNEL_IN_UBI := 1
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-usb3 kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware
endef
...
define Device/dlink_aquila-pro-ai-m30-a1
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-leds-gca230718 kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware
  KERNEL_IN_UBI := 1
  IMAGES += recovery.bin
  IMAGE_SIZE := 51200k
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
...
define Device/glinet_gl-mt2500
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_DTS_LOADADDR := 0x47000000
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h -wpad-basic-mbedtls e2fsprogs f2fsck mkf2fs kmod-usb3
...
define Device/glinet_gl-mt3000
  ...
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware kmod-hwmon-pwmfan kmod-usb3
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 246272k
...
define Device/glinet_gl-mt6000
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h e2fsprogs f2fsck mkf2fs kmod-usb3 kmod-mt7915e kmod-mt7986-firmware mt7986-wo-firmware
  IMAGES += factory.bin
...
define Device/glinet_gl-x3000-xe3000-common
  DEVICE_VENDOR := GL.iNet
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware mkf2fs \
...
define Device/mediatek_mt7981-rfb
  ...
  DEVICE_DTC_FLAGS := --pad 4096
  DEVICE_DTS_LOADADDR := 0x43f00000
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-mt7915e kmod-mt7981-firmware kmod-usb3 e2fsprogs f2fsck mkf2fs mt7981-wo-firmware
  KERNEL_LOADADDR := 0x44000000
  KERNEL := kernel-bin | gzip
  KERNEL_INITRAMFS := kernel-bin | lzma | \
	fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb with-initrd | pad-to 64k
...
define Device/mediatek_mt7988a-rfb
  ...
  DEVICE_DTC_FLAGS := --pad 4096
  DEVICE_DTS_LOADADDR := 0x45f00000
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h mt7988-2p5g-phy-firmware kmod-sfp
  KERNEL_LOADADDR := 0x46000000
  KERNEL := kernel-bin | gzip
  KERNEL_INITRAMFS := kernel-bin | lzma | \
	fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb with-initrd | pad-to 64k
...
define Device/openwrt_one
  ...
  DEVICE_DTC_FLAGS := --pad 4096
  DEVICE_DTS_LOADADDR := 0x43f00000
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware kmod-rtc-pcf8563 kmod-usb3 kmod-nvme
  KERNEL_LOADADDR := 0x44000000
  KERNEL := kernel-bin | gzip
  KERNEL_INITRAMFS := kernel-bin | lzma | \
	fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb with-initrd | pad-to 64k
...
define Device/tplink_tl-xdr-common
  ...
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h fitblk kmod-usb3 kmod-mt7915e kmod-mt7986-firmware mt7986-wo-firmware
  ARTIFACTS := preloader.bin bl31-uboot.fip
  ARTIFACT/preloader.bin := mt7986-bl2 spim-nand-ddr3
endef
...
define Device/ubnt_unifi-6-plus
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware e2fsprogs f2fsck mkf2fs fdisk partx-utils
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
...
define Device/unielec_u7981-01
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware kmod-usb3 e2fsprogs f2fsck mkf2fs fdisk partx-utils
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
...
define Device/xiaomi_redmi-router-ax6000-stock
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-leds-ws2812b kmod-mt7915e kmod-mt7986-firmware mt7986-wo-firmware
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
ifneq ($(CONFIG_TARGET_ROOTFS_INITRAMFS),)
...
define Device/zbtlink_zbt-z8102ax
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware kmod-usb3 kmod-usb-net-qmi-wwan kmod-usb-serial-option
  KERNEL_IN_UBI := 1
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
...
define Device/zyxel_ex5601-t0-stock
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-mt7915e kmod-mt7986-firmware mt7986-wo-firmware kmod-usb3
  SUPPORTED_DEVICES := mediatek,mt7986a-rfb-snand
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 256k
  PAGESIZE := 4096
...
define Device/zyxel_ex5700-telenor
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-ubootenv-nvram kmod-usb3 kmod-mt7915e kmod-mt7916-firmware kmod-mt7986-firmware mt7986-wo-firmware
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 65536k
...
define Device/zyxel_nwa50ax-pro
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := -kmod-phy-airoha-en8811h kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware zyxel-bootconfig
  DEVICE_DTS_LOADADDR := 0x44000000
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
