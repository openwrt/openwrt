...
define Device/cmcc_rax3000z
  DEVICE_VENDOR := CMCC
  DEVICE_MODEL := RAX3000Z
  DEVICE_DTS := mt7981b-cmcc-rax3000z
  DEVICE_DTS_OVERLAY := mt7981b-cmcc-rax3000z-emmc mt7981b-cmcc-rax3000z-nand
  DEVICE_DTS_DIR := ../dts
  DEVICE_DTC_FLAGS := --pad 4096
  DEVICE_DTS_LOADADDR := 0x43f00000
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware kmod-usb3 \
  ...
  ARTIFACT/emmc-gpt.bin := mt798x-gpt emmc
  ARTIFACT/emmc-preloader.bin := mt7981-bl2 emmc-ddr4
  ARTIFACT/emmc-bl31-uboot.fip := mt7981-bl31-uboot cmcc_rax3000z-emmc
  ARTIFACT/nand-preloader.bin := mt7981-bl2 spim-nand-ddr4
  ARTIFACT/nand-bl31-uboot.fip := mt7981-bl31-uboot cmcc_rax3000z-nand
endef
TARGET_DEVICES += cmcc_rax3000z
