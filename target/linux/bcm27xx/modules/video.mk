...
define KernelPackage/camera-bcm2835
  ...
  KCONFIG:= \
    ...
    CONFIG_VIDEO_ARDUCAM_64MP=n@ge6.1 \
    CONFIG_VIDEO_ARDUCAM_PIVARIETY=n@ge6.1 \
    CONFIG_VIDEO_BCM2835_UNICAM=n \
    CONFIG_VIDEO_IMX296=n@ge6.1 \
    CONFIG_VIDEO_IMX519=n@ge6.1 \
    CONFIG_VIDEO_IMX708=n@ge6.1 \
...
define KernelPackage/drm-vc4
  ...
  KCONFIG:= \
    ...
    CONFIG_DRM_TVE200=n
  FILES:= \
    $(LINUX_DIR)/drivers/gpu/drm/display/drm_display_helper.ko@ge6.1 \
