				...
				unsigned int mode, phy_interface_t interface)
{
	...
	reg_clear(priv, XGMAC_RX_CONFIG, XGMAC_CONFIG_RE);
...
static int xgmac_phy_setup(struct xgmac_priv *priv)
{
	...
	priv->phylink_config.mac_capabilities = MAC_SYM_PAUSE | MAC_ASYM_PAUSE |
						...
						MAC_2500FD;
	__set_bit(PHY_INTERFACE_MODE_SGMII, priv->phylink_config.supported_interfaces);
...
MODULE_DESCRIPTION("Ethernet XGMAC driver for SF21A6826P SoC");
