#ifndef _DT_BINDINGS_SF21A6826P_IOMUX_H
#define _DT_BINDINGS_SF21A6826P_IOMUX_H
...
#define SW_OEN		(1 << 7)	/* Output enable negate (i.e. disable) */
...
#define FUNC_SW_SEL	(1 << 12)	/* Pin function enable */
