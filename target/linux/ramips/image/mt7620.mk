...
define Device/dlink_dir-819-a1
  ...
  DEVICE_PACKAGES := kmod-mt76x0e
  DEVICE_VENDOR := D-Link
  DEVICE_MODEL := DIR-819
  DEVICE_VARIANT := A1
  KERNEL := $(KERNEL_DTB)
  DEVICE_TITLE := D-Link DIR-819 A1
  IMAGES += factory.bin
  IMAGE/factory.bin := append-kernel | pad-to 1900544 | append-rootfs | pad-rootfs | $(STAGING_DIR_HOST)/bin/tbs_dlink tbs_dlink -g CA -m DIR819 -p DIR-819 $@
