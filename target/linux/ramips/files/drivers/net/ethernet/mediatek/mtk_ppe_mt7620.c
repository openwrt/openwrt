...
/* Absolute FE offset; this register is outside the PPE block below. */
#define MT7620_FE_TIMESTAMP		0x0010
			 ...
			 const struct mt7620_ppe_flow_data *out)
{
	 ...
	 * map, so use the MT7620-specific absolute FE register definition.
	 */
	timestamp = mt7620_ppe_r32(ppe, MT7620_FE_TIMESTAMP) &
		    MT7620_PPE_IB1_TIMESTAMP;
...
mt7620_ppe_flow_stats(struct mt7620_ppe *ppe, struct flow_cls_offload *f)
{
	...
	if (FIELD_GET(MT7620_PPE_IB1_STATE, info) == MT7620_PPE_STATE_BIND) {
		now = mt7620_ppe_r32(ppe, MT7620_FE_TIMESTAMP) &
		      MT7620_PPE_IB1_TIMESTAMP;
